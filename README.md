...
reverted. The full campaign history -- Phases 15--27, each with methodology
...
### Simulation battery -- validated multi-genre gameplay matrix

Phase 26--27 built a workload-independent benchmark suite with deterministic
...
|---|---|---|---|---|
| SOCIAL | 0.7 / 1.4 ms | 3.4 / 4.6 ms | 3.7 / 5.3 ms | **8.4 / 10.0 ms [OK]** |
| FPS (WASM combat) | 2.4 / 3.9 ms | 10.2 / 14.4 ms | **10.5 / 12.1 ms [OK]** | 29.5 / 32.9 ms |
| MMO (economy+social) | 2.1 / 3.7 ms | 11.7 / 16.0 ms | **12.8 / 14.6 ms [OK]** | 29.5 / 44.9 ms |
| SURVIVAL (RMW economy) | 2.1 / 3.3 ms | 11.3 / 14.1 ms | **11.2 / 12.7 ms [OK]** | 26.0 / 31.1 ms |
...
- WASM fire reduced from 994 us to ~12 us via instance pooling + composite ops.
